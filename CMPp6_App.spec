...
a = Analysis(
    ...
    hiddenimports=['sklearn.utils._typedefs', 'sklearn.neighbors._partition_nodes', 'sklearn.neighbors._quad_tree', 'sklearn.tree._utils', 'sklearn.utils._cython_blas', 'sklearn.neighbors._typedefs', 'scipy.special.cython_special', 'scipy.stats._stats', 'pandas._libs.tslibs.base', 'pandas._libs.tslibs.np_datetime', 'pandas._libs.tslibs.nattype', 'pandas._libs.tslibs.timedeltas', 'skimage.filters.rank.core_cy_3d', 'qimage2ndarray'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
